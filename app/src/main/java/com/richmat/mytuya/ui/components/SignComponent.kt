...
import com.richmat.mytuya.ui.sign.textFieldState.EmailState
...
fun SignInSignUpTopAppBar(
    topAppBarText: String, onBackPressed: () -> Unit, actions: @Composable RowScope.() -> Unit = {
...
fun Email(
    ...
    OutlinedTextField(
        colors = TextFieldDefaults.outlinedTextFieldColors(
            ...
            focusedLabelColor = Color.Green.copy(alpha = ContentAlpha.high)
        ),
